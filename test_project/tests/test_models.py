...
from appointments.periods import Period, Month, Day
...
class TestEvent(TestCase):
    ...
    def setUp(self):
        rule = models.Rule(frequency="WEEKLY")
        rule.save()
        cal = models.Calendar(name="MyCal")
        cal.save()
        self.recurring_data = {
            'title': 'Recent Event',
    ...
    def test_recurring_event_get_occurrences(self):
        recurring_event = models.Event(**self.recurring_data)
    ...
    def test_get_occurrence(self):
        event = models.Event(**self.recurring_data)
        event.save()
...
class TestOccurrence(TestCase):
    ...
    def setUp(self):
        ...
        self.recurring_event = models.Event(**self.recurring_data)
    ...
    def test_moved_occurrences(self):
        ...
        period_post = Period(
            [self.recurring_event], span_post[0], span_post[1])
